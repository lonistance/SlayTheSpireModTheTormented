...
public class ExecutionFormPower extends BasePower {
    public static final String POWER_ID = makeID(ExecutionFormPower.class.getSimpleName());
    ...
    public ExecutionFormPower(AbstractCreature owner, int amount) {
