...
public class Pursuit extends BaseCard {
    public static final String ID = makeID(Pursuit.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private boolean hasPreviousAttack() {
