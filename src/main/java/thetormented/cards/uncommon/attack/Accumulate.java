...
public class Accumulate extends BaseCard {
    public static final String ID = makeID(Accumulate.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
