...
public class Agony extends BaseCard {
    ...
    // 2. 数值配置变量（方便后期调整平衡性）
    private static final int DAMAGE_BASE = 10;
    private static final int DAMAGE_UPGRADE = 2; // 升级后增加 1（总共 8）

    private static final int MAGIC_NUM = 1;      // 给予 1 层虚弱
    private static final int UPG_MAGIC_NUM = 1; // 给予 1 层易伤
