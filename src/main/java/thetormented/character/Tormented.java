package thetormented.character;
...
import static thetormented.BasicMod.characterPath;
import static thetormented.BasicMod.makeID;

public class Tormented extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("TheTormented"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass TORMENTED;
        @SpireEnum(name = "CHARACTER_RUST_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_RUST_COLOR") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(53f/255f, 18f/255f, 14f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Tormented(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public Tormented() {
        super(getNames()[0], Meta.TORMENTED,
